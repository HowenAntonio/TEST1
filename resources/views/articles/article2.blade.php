...
<body>
    ...
    @section('content')
        ...
        <div class="jumbotron position-relative">
            ...
            <h1 class="text-center mt-5 text-light pt-4">Article 2</h1>
            <p class="d-block mx-auto text-light text-center mt-3 fs-5">Posted At : 20 December 2024</p>
            <img src="{{ asset('images/article2.png') }}" class="img-fluid mt-4 d-block mx-auto border border-danger" alt="Example Image">
